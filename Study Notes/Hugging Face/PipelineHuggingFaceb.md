...
> 💬 _a diagram should be inserted_
...
‘Behind the pipeline - Hugging Face NLP Course’. Accessed: Mar. 16, 2025. [Online]. Available: [https://huggingface.co/learn/nlp-course/en/chapter2/2](https://huggingface.co/learn/nlp-course/en/chapter2/2)